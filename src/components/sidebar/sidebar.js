        ...
        <div className="p-4 ">
          <div className="flex justify-between mb-2">
            ...
            <div className="flex space-x-4 ">
              <p className="bg-[#ffffff] cursor-pointer flex justify-center items-center  text-[0.85rem] text-[#656565] pr-3 pl-3">
                Day
              </p>
              <p className="bg-[#ffffff] flex justify-center items-center  text-[0.85rem] text-[#656565] pr-3 pl-3">
                Week
              </p>
              <p className="bg-[#ffffff] flex justify-center items-center  text-[0.85rem] text-[#656565] pr-3 pl-3">
                Month
